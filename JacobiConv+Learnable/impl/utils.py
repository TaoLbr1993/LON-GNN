...
def parse_args():
    ...
    # Learnable base Settings
    parser.add_argument('--learnable_bases', action="store_true")
    parser.add_argument('--search_init_ab', action="store_true")
    parser.add_argument('--wd4', type=float, default=5e-4)
    parser.add_argument('--lr4', type=float, default=0.005)

    # Normalization Settings
    parser.add_argument('--normalized_bases', action="store_true")
